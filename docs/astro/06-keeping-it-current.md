...
Integrations → Vercel → Manage · set in steps 5 and 7.* The textbook connected
line: all four use the `PUBLIC_` prefix (step 8.3 configures the integration to inject
