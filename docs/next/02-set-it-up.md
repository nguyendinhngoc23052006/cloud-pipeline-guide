...
- A committed package-lock.json; .github/dependabot.yml (weekly npm + github-actions, grouped); .env.example with the NEXT_PUBLIC_SUPABASE_* vars; .gitignore ignoring .env*.
