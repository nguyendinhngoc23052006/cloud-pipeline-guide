...
Supabase → Project → Settings → Integrations → Vercel → Manage · set in steps 5
and 7.* The textbook connected line: all five use the `VITE_` prefix
(step 8.3 configures the integration to inject `VITE_` into previews, matching
